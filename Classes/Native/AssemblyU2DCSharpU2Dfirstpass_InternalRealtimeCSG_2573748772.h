...
struct  GeneratedMeshes_t2573748772  : public MonoBehaviour_t1158329972
{
public:
...
public:
	inline static int32_t get_offset_of_Version_2() { return static_cast<int32_t>(offsetof(GeneratedMeshes_t2573748772, ___Version_2)); }
